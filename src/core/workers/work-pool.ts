 ...
 * @Last Modified time: 2018-09-30 04:25:15
 */
import DecodeCodeToPixelsWork from 'worker!./decode-code-to-pixels'; //tslint:disable-line
...
workPool.registerWork('decodeCodeToPixelsWork', DecodeCodeToPixelsWork);
