...
export class Go {
    constructor() {
        ...
        const loadSlice = (array, len, cap) => {
            return new Uint8Array(this.exports.memory.buffer, array, len);
        };
        ...
        const loadString = (ptr, len) => {
            return decoder.decode(new DataView(this.exports.memory.buffer, ptr, len));
        };
        ...
        this.importObject = {
            ...
            env: {
                ...
                'runtime.sleepTicks': (timeout) => {
                    ...
                    setTimeout(this.exports.go_scheduler, timeout);
                },
    ...
    exec(eventName, params) {
        if (!window.GO) window.GO = {};
        window.GO[id] = params;
        this.exports[eventName](id);
        id += 1;
    }
